...
def calcAproveitamento(tentativas):
    convertidos = 0
    for valor in tentativas:
        if valor != 0:
            convertidos += 1
...
tentativas = registrarTent()

pontuacao = calcularPonto(tentativas)
aproveitamento = calcAproveitamento(tentativas)
